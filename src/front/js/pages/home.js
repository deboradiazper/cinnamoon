  ...
  <div className="container">
    <div className="row">
      <div className="col-12">
        ...
        <div className="recipes d-flex justify-content-between mt-5 mb-4">
          <h4>The new recipes</h4>
          <button className="number border-0 text-light d-flex align-items-center justify-content-center">
