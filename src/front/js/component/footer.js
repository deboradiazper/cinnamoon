  ...
  return (
    <div className="container-fluid p-0 mt-5">
      <div className="row">
        ...
        >
          <h3 className="title-all2 pt-5 px-3 text-center">RECETAS PARA TODOS</h3>
          <ul className="py-2 px-3">
            <li>El <b>calcio que mejor se absorbes</b> no es el de los lácteo, sino el de las algas.</li>
            <li><b>Eliminar el gluten</b>de tu dieta mejora tu salud intestinal.</li>
            <li>Es posible <b>endulzar tus platos</b> con alimentos que tienen azúcar en su composición</li>
            <li>Una alimentación <b>vegana</b> puede ser rica en proteínas de origen vegetal.</li>
          </ul>
        </div>
      ...
      <div className="row">
        ...
        >
          ...
          <p className="py-2 px-3"><b>Okinawa</b>,es una isla en el sur de Japón que se ha hecho conocer por tener la esperanza de vida más elevada del mundo.
            Su alimentación fundamentada en <b>productos de origen vegetal</b> y pobre en acidos grasos parece ser la clave de su <b>longevidad</b>.
          </p>
        </div>
      </div>
